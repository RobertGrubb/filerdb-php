...
class Databases
{
    ...
    public function create($database)
    {
        ...
        if ($exists) {
            throw new FilerDBException('Database already exists');
        }
        ...
        if (!$created) {
            throw new FilerDBException('Database was unable to be created');
        }
    ...
    public function delete($database)
    {
        ...
        if (!$removed) {
            throw new FilerDBException('Database was unable to be deleted');
        }
